            ...
            <Tabs defaultValue="tasks" className="space-y-6">
                ...
                <div className="flex justify-center sm:justify-start mb-2">
                    <TabsList className="grid w-full sm:w-auto grid-cols-2">
                        <TabsTrigger value="tasks">Production Queue</TabsTrigger>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                <div>
                                    <CardTitle className="flex items-center text-2xl">
                                        <Printer className="h-6 w-6 mr-3 text-blue-600" />Production Queue
                                    </CardTitle>
                        ...
                        <CardContent className="px-4 sm:px-6">
                            ...
                            <div className="mb-6 flex overflow-x-auto pb-2 scrollbar-hide gap-2">
                                ...
                                {['assigned', 'in_progress', 'completed'].map(status => {
                                    const displayStatus = status === 'assigned'
                                        ? 'Queued'
                                        : status === 'in_progress'
                                            ? 'Production'
                                            : 'Completed';
                            ...
                            {isLoading ? (
                                ...
                                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                    {getFilteredTasks.map((task) => {
                                        ...
                                        const displayStatus = task.status === 'assigned'
                                            ? 'Queued'
